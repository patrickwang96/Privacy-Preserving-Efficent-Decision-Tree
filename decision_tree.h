...
void secure_feature_selection_with_one_node_client(const matrix_z p, const matrix_z feature_share, mpz_class selected_feature, int index, NetAdapter *net);

void secure_feature_selection_with_one_node_server(const matrix_z p, const matrix_z feature_share, mpz_class selected_feature, int index, NetAdapter *net);
...
void secure_inference_generation_client(int decision[], mpz_class value[], int depth, mpz_class result, const triplet_b& tri_b, const triplet_z& tri_z, NetAdapter *net);

void secure_inference_generation_server(int decision[], mpz_class value[], int depth, mpz_class result, const triplet_b& tri_b, const triplet_z& tri_z, NetAdapter *net);
